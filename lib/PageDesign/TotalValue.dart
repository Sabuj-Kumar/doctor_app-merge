...
class TotalValue extends StatefulWidget {
  const TotalValue({Key key}) : super(key: key);

  @override
  _RetailStoreState createState() => _RetailStoreState();
}

class _RetailStoreState extends State<TotalValue> {
  @override
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Your total value of the all product",
              style: TextStyle(
                  fontSize: 20.0,
                  fontWeight: FontWeight.bold,
                  color: Colors.white),
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => RetailStoreList()),
                          );
                        },
